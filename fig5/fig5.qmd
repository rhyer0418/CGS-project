...
\(E\) The relative lipid content of each group. Each box centres on the median, with lower and upper bounds representing the first and third quartile (25th and 75th percentile), respectively (*n* = 8). (F) The ratio of liver weight to body weight in different groups. (G−H) Level of serum glucose and serum TBA. (I−L) Levels of serum ALT, AST, TC, and TG.
